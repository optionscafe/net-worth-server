...
//
func TestDoLogin01(t *testing.T) {
	...
	// Post data
	var postStr = []byte(`{ "email": "spicer@cloudmanic.com", "password": "foobar" }`)
	...
	// Post data
	postStr = []byte(`{ "email": "spicer@cloudmanic.com", "password": "abc123" }`)
