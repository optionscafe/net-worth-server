...
func MarkTradier(db *models.DB) error {
  ...
  processMarkTradier(db, balances, targetAccountId, date)
...
//
func processMarkTradier(db *models.DB, balances []tradier.Balance, targetAccountId uint, date time.Time) error {
